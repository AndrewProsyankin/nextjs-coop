...
const Header = () => {
  ...
  const totalItemsCount = cartItems.reduce((total, item) => total + item.quantity, 0); // Общее количество товаров в корзине
  ...
  if (!mounted) {
    return null; // или заглушка, если необходимо
  }
      ...
      <header className="relative bg-white">
        ...
        <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between border-b border-gray-200 py-4">
            ...
            {/* Icons (Cart, Notifications, Profile) */}
